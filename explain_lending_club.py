...
def explain_lending_club_model(processed_data_path, model_path, random_state=42):
    print("Starting explanation generation for LendingClub dataset...")
    ...
    print("SHAP explanation generated for LendingClub dataset.")
    ...
    with open("explainable-credit-scoring/explanation_generation/lending_club_explanations.txt", "w") as f:
        f.write("LendingClub Explanations\n")
        f.write(str(feature_importance_shap.nlargest(10)))

    # Save SHAP values for further analysis
    shap_output_path = "explainable-credit-scoring/explanation_generation/lending_club_shap_values.pkl"
...
if __name__ == "__main__":
    ...
    explain_lending_club_model(processed_data_path, model_path)
